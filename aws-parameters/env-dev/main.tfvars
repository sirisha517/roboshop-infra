parameters = [
  ...
  { name = "dev.user.mongo_url", value = "mongodb://mongno-dev.devops517test.online:27017/catalogue", type = "String" },
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devops517test.online", type = "String" },
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://mongno-dev.devops517test.online:27017/users", type = "String" },
