parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devops517test.online:80/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devops517test.online:80/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devops517test.online:80/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devops517test.online:80/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devops517test.online:80/", type = "String" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devops517test.online:80", type = "String" },
